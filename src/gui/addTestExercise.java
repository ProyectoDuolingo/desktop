...
public class addTestExercise extends JFrame {
	...
	private JTextField textWrongSent1;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					addTestExercise frame = new addTestExercise();
	...
	public addTestExercise() {
		...
		JLabel lblSentToTrans = new JLabel("Frase a traduir:");
		
		textSentToTrans = new JTextField();
		textSentToTrans.setColumns(10);
		
		JLabel lblSentCorrect = new JLabel("Frase traduïda correcta:");
		...
		textWrongSent1 = new JTextField();
		textWrongSent1.setColumns(10);
		...
		JButton btnSaveAtDB = new JButton("GUARDAR A LA BASE DE DADES");
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(lblSentWrong1)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(textWrongSent1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(lblSentWrong2)
					.addPreferredGap(ComponentPlacement.RELATED)
